...
function PrivacyPolicy() {
  return (
    <>
      ...
      >
        ...
        <h4>General Terms of Service</h4>
          ...
          transition={{duration: 1}}>
            ...
            website, you agree to these Terms of Service and Legal Notices set
            forth below and any other disclaimers and terms and conditions
            stated on the site (“Terms of Service”, or “Terms”).
          </motion.p>
          <motion.p
                    initial={{opacity: 0}}
                    whileInView={{opacity:1}}
            ...
            contained in the material. You must not modify, alter, distribute,
            or use the material for public or commercial purposes without
            written permission from an authorized representative of the Company.
            It is strictly prohibited to alter the images of our products.
          </motion.p>
          <motion.p
                    initial={{opacity: 0}}
                    whileInView={{opacity:1}}
      ...
      <motion.div className="banner-one-container"
